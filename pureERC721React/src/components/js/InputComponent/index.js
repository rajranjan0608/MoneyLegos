...
class Input extends React.Component {
  ...
  setCategory = async (item) => {
    await this.setState({selectedCategory:item});
    this.props.token(this.state.selectedCategory)
    this.handleClick();
  }

  dropdownList = () => {
    let {auxArray, searchText, selectedCategory} = this.state;
    return (
      <div className='dropdown-container'>
        <div className='dropdown-input'>
          <div className='dropdown-input-div'>
            <input className='input' onChange={e => {this.handleSearch(e)}} value={searchText} placeholder="Type a currency or ticket" type="text" />
          </div>
  ...
  inputForm = () => {
    ...
    <div className='input-container'>
      <div className='input-box'>
        <input className='input' onChange={e => {this.props.amount(e); this.handleChange(e)}} placeholder={this.props.typeOfInput} type="text" value={inputText} />
      </div>
